...
public class InventoryConstants {
    ...
    public static final int PLAYER_INV_STORAGE_LENGTH = PLAYER_INV_ROW_LENGTH * PLAYER_INV_ROW_COUNT;
    public static final int PLAYER_INV_ARMOUR_LENGTH = 4;
    public static final int PLAYER_INV_EXTRA_LENGTH = 1;
    public static final int PLAYER_INV_LENGTH = PLAYER_INV_STORAGE_LENGTH + PLAYER_INV_ARMOUR_LENGTH + PLAYER_INV_EXTRA_LENGTH;
}
