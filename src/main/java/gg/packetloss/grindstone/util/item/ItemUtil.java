...
public class ItemUtil {
  ...
  public static final ItemStack[] LEATHER_ARMOUR = new ItemStack[] {
  ...
  public static final ItemStack[] IRON_ARMOUR = new ItemStack[] {
  ...
  public static final ItemStack[] GOLD_ARMOUR = new ItemStack[] {
  ...
  public static final ItemStack[] DIAMOND_ARMOUR = new ItemStack[] {
  ...
  public static int countFilledSlots(ItemStack[] inventory) {
    ...
    for (ItemStack aItemStack : inventory) {
      if (aItemStack != null && aItemStack.getTypeId() != 0) {
        count++;
      }
    }
    return count;
  ...
  public static boolean findItemOfName(ItemStack[] itemStacks, String name) {
    ...
    for (ItemStack itemStack : itemStacks) {
      if (matchesFilter(itemStack, name)) {
        return true;
      }
    }
    return false;
  ...
  public static boolean removeItemOfType(InventoryHolder inventoryHolder, int typeId, int quantity, boolean ignoreToSmall) {
    ...
    if (c == 0 || (c < quantity && !ignoreToSmall)) {
      return false;
    }
  ...
  public static int countItemsOfName(ItemStack[] itemStacks, String name) {
    ...
    int count = 0;
    for (ItemStack itemStack : itemStacks) {
      if (matchesFilter(itemStack, name, false)) {
  ...
  public static boolean hasAncientArmour(LivingEntity entity) {
    ...
    if (equipment != null) {
      armour = equipment.getArmorContents();
    } else {
      return false;
    }
