...
public enum ItemType {
  ...
  private static final Set<Integer> USES_DAMAGE_VALUE = new HashSet<>();
  ...
  static {
    USES_DAMAGE_VALUE.add(BlockID.DIRT);
    USES_DAMAGE_VALUE.add(BlockID.WOOD);
    USES_DAMAGE_VALUE.add(BlockID.SAPLING);
    USES_DAMAGE_VALUE.add(BlockID.SAND);
    USES_DAMAGE_VALUE.add(BlockID.LOG);
    USES_DAMAGE_VALUE.add(BlockID.LEAVES);
    USES_DAMAGE_VALUE.add(BlockID.SANDSTONE);
    USES_DAMAGE_VALUE.add(BlockID.LONG_GRASS);
    USES_DAMAGE_VALUE.add(BlockID.CLOTH);
    USES_DAMAGE_VALUE.add(BlockID.RED_FLOWER);
    USES_DAMAGE_VALUE.add(BlockID.DOUBLE_STEP);
    USES_DAMAGE_VALUE.add(BlockID.STEP);
    USES_DAMAGE_VALUE.add(BlockID.SILVERFISH_BLOCK);
    USES_DAMAGE_VALUE.add(BlockID.STONE_BRICK);
    USES_DAMAGE_VALUE.add(BlockID.BROWN_MUSHROOM_CAP);
    USES_DAMAGE_VALUE.add(BlockID.RED_MUSHROOM_CAP);
    USES_DAMAGE_VALUE.add(BlockID.DOUBLE_WOODEN_STEP);
    USES_DAMAGE_VALUE.add(BlockID.WOODEN_STEP);
    USES_DAMAGE_VALUE.add(BlockID.COBBLESTONE_WALL);
    USES_DAMAGE_VALUE.add(BlockID.ANVIL);
    USES_DAMAGE_VALUE.add(BlockID.QUARTZ_BLOCK);
    USES_DAMAGE_VALUE.add(BlockID.STAINED_CLAY);
    USES_DAMAGE_VALUE.add(BlockID.CARPET);

    USES_DAMAGE_VALUE.add(ItemID.COAL);
    USES_DAMAGE_VALUE.add(ItemID.INK_SACK);
    USES_DAMAGE_VALUE.add(ItemID.POTION);
    USES_DAMAGE_VALUE.add(ItemID.SPAWN_EGG);
    USES_DAMAGE_VALUE.add(ItemID.MAP);
    USES_DAMAGE_VALUE.add(ItemID.HEAD);
    USES_DAMAGE_VALUE.add(ItemID.GOLD_APPLE);
    USES_DAMAGE_VALUE.add(ItemID.RAW_FISH);
    USES_DAMAGE_VALUE.add(ItemID.COOKED_FISH);
  }
  ...
  public static boolean usesDamageValue(int id) {
    ...
    return USES_DAMAGE_VALUE.contains(id);
  }
