...
public class CombatantExtractor<Attacker extends Entity, Defender extends Entity, Thrown extends Projectile>
  ...
  public CombatantExtractor(Class<Attacker> attackerType, Class<Defender> defenderType, Class<Thrown> thrownClass) {
