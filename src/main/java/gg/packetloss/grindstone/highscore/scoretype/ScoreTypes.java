...
public class ScoreTypes {
    ...
    public static final ScoreType JUNGLE_RAID_WINS = new BasicScoreType(3, false, true, ScoreType.Order.DESC);
    public static final ScoreType GOLD_RUSH_ROBBERIES = new BasicScoreType(4, true, true, ScoreType.Order.DESC);
    public static final ScoreType FASTEST_GOLD_RUSH = new TimeBasedScoreType(5, true, false, ScoreType.Order.ASC);
    public static final ScaledScoreType SACRIFICED_VALUE = new ScaledScoreType(6, true, true, ScoreType.Order.DESC, 60.243);
    public static final ScoreType COW_KILLS = new KillCounterScoreType(7, true);
    public static final ScoreType APOCALYPSE_MOBS_SLAIN = new BasicScoreType(8, true, true, ScoreType.Order.DESC);
    public static final ScoreType CURSED_ORES_MINED = new BasicScoreType(9, true, true, ScoreType.Order.DESC);
    public static final ScoreType CURSED_MINE_DEATHS = new BasicScoreType(10, true, true, ScoreType.Order.DESC);
    public static final ScoreType MIRAGE_ARENA_KILLS = new KillCounterScoreType(11, false);
    public static final ScoreType SKY_WARS_WINS = new BasicScoreType(12, false, true, ScoreType.Order.DESC);
    ...
    public static final ScoreType NINJA_PARKOUR_FASTEST_RUN = new TimeBasedScoreType(17, false, false, ScoreType.Order.ASC);
    public static final ScoreType NINJA_PARKOUR_CROSSINGS = new BasicScoreType(18, false, true, ScoreType.Order.DESC);
    public static final ScoreType GRAVE_YARD_LOOTINGS = new BasicScoreType(19, true, true, ScoreType.Order.DESC);
