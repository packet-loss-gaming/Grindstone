...
public class RogueComponent extends BukkitComponent implements Listener, Runnable {
      ...
      if (isRogue(player)) {
        ...
        for (Entity entity : entities) {
          ...
          if (entity instanceof LivingEntity) {
            if (entity instanceof Player && !PvPComponent.allowsPvP(player, (Player) entity)) {
              continue;
            }
    ...
    if (result.hasProjectile()) {
      ...
      if (defender instanceof Player && ChanceUtil.getChance(3)) {
        ...
        if (rogueSession.isRogue() && rogueSession.canBacklash() && rogueSession.canBlip()) {
          if (attacker instanceof Player && !PvPComponent.allowsPvP((Player) attacker, (Player) defender)) {
            return;
          }
  ...
  public void onProjectileLand(ProjectileHitEvent event) {
    ...
    if (p.getShooter() == null || !(p.getShooter() instanceof LivingEntity)) {
      return;
    }
    if (p instanceof Snowball && p.hasMetadata("rogue-snowball")) {
      ...
      if (p.hasMetadata("nightmare")) {
        ...
        for (Entity entity : p.getNearbyEntities(3, 3, 3)) {
          if (!entity.isValid() || entity.equals(shooter) || !(entity instanceof LivingEntity)) {
            continue;
          }
          ...
          if (entity instanceof Player) {
            ...
            if (shooter instanceof Player) {
              if (!PvPComponent.allowsPvP((Player) shooter, (Player) entity)) {
                continue;
              }
            }
          }

          if (((LivingEntity) entity).getHealth() < 2) {
            continue;
          }
        ...
        for (Entity entity : p.getNearbyEntities(4, 4, 4)) {
          ...
          if (entity instanceof Player) {
            ...
            if (shooter instanceof Player) {
              if (!PvPComponent.allowsPvP((Player) shooter, defender)) {
                return;
              }
            }
