...
import gg.packetloss.grindstone.prayer.impl.BufferFingersPrayer;
    ...
    if (ChanceUtil.getChance(256)) {
      ...
      switch (ChanceUtil.getRandom(5)) {
        ...
        case 2:
          ...
          break;
        case 3:
          new BufferFingersPrayer().add(player);
  ...
  public void onEntityDeath(EntityDeathEvent event) {
    ...
    if (ent instanceof Slime && contains(ent)) {
      ...
      while (dropIterator.hasNext()) {
        ...
        if (next != null && next.getTypeId() == ItemID.SLIME_BALL) {
          dropIterator.remove();
        }
      }
    }
