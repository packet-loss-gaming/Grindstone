...
public enum ItemType {
    ...
    SPRUCE_WOOD(BlockID.WOOD, 1, "Spruce Wood", "sprucewood", "sprucewoodplanks", "spruceplanks"),
    BIRCH_WOOD(BlockID.WOOD, 2, "Birch Wood", "birchwood", "birchwoodplanks", "birchplanks"),
    JUNGLE_WOOD(BlockID.WOOD, 3, "Jungle Wood", "junglewood", "junglewoodplanks", "jungleplanks"),
    ...
    LOG(BlockID.LOG, 0, "Log", "log"),
    SPRUCE_LOG(BlockID.LOG, 1, "Spruce Log", "sprucelog"),
    BIRCH_LOG(BlockID.LOG, 2, "Birch Log", "birchlog"),
    JUNGLE_LOG(BlockID.LOG, 3, "Jungle Log", "junglelog"),
    ...
    STEP(BlockID.STEP, 0, "Step", "slab", "stoneslab", "step", "halfstep"),
    ...
    WOODEN_STEP(BlockID.WOODEN_STEP, 0, "Wood step", "woodenslab", "woodslab", "woodstep", "woodhalfstep"),
    ...
    INK_SACK(ItemID.INK_SACK, 0, "Ink sac", "inksac", "ink", "dye", "inksack"),
