...
public enum ItemType {
    ...
    LOG(BlockID.LOG, 0, "Log", "log", "tree", "pine", "oak", "birch", "redwood"),
    ...
    SILVERFISH_BLOCK(BlockID.SILVERFISH_BLOCK, 0, "Silverfish block", "silverfish", "silver"),
    ...
    QUARTZ_BLOCK(BlockID.QUARTZ_BLOCK, 0, "Block of Quartz", "quartzblock"),
    ...
    ENHANCED_GOLD_APPLE(ItemID.GOLD_APPLE, 1, "Enhanced Golden apple", "enhancedgoldapple", "notchapple"),
    ...
    ZOMBIE_SKULL(ItemID.HEAD, 2, "Zombie Skull", "zombieskull", "zombehead"),
